    ...
    public class InternalEntityTypeBuilder : InternalMetadataItemBuilder<EntityType>
    {
            ...
            ConfigurationSource configurationSource)
        {
            ...
            return principalType == null
                ? null
                : ForeignKeyInternal(principalType, GetOrCreateProperties(propertyNames, configurationSource), configurationSource);
        }
            ...
            ConfigurationSource configurationSource)
        {
            ...
            return principalType == null
                ? null
                : ForeignKeyInternal(principalType, GetOrCreateProperties(clrProperties, configurationSource), configurationSource);
        }
        ...
        public virtual InternalRelationshipBuilder ForeignKey(
            ...
            ConfigurationSource configurationSource)
            => ForeignKeyInternal(principalEntityTypeBuilder,
                GetOrCreateProperties(dependentProperties, configurationSource),
                configurationSource);

        private InternalRelationshipBuilder ForeignKeyInternal(
            [NotNull] InternalEntityTypeBuilder principalEntityTypeBuilder,
            ...
            ConfigurationSource configurationSource)
        {
            ...
            return relationship.ForeignKey(dependentProperties, configurationSource);
        }
            ...
            ConfigurationSource configurationSource)
        {
                ...
                if (!toTargetCanBeUnique)
                {
                    return Navigations(
                        Relationship(targetEntityTypeBuilder, configurationSource)
                            ...
                            .Unique(false, configurationSource),
                        null,
            ...
            if (!toTargetCanBeNonUnique
                && !toSourceCanBeNonUnique)
            {
                relationship = relationship.Unique(true, configurationSource);
            }
            else
            {
                relationship = relationship.Unique(true, ConfigurationSource.Convention);
            }
