    ...
    public class ForeignKeyPropertyDiscoveryConventionTest
    {
        ...
        public void Does_not_match_dependent_PK_for_non_unique_FK()
        {
            ...
            var relationshipBuilder = DependentType.Relationship(PrincipalType, ConfigurationSource.Convention)
                .Unique(false, ConfigurationSource.Convention);
        ...
        public void Does_not_match_non_nullable_dependent_PK_for_optional_unique_FK()
        {
            ...
            var relationshipBuilder = DependentType.Relationship(PrincipalType, ConfigurationSource.Convention)
                ...
                .Required(false, ConfigurationSource.DataAnnotation);
        ...
        public void Does_not_match_composite_dependent_PK_for_non_unique_FK()
        {
            ...
            var relationshipBuilder = DependentTypeWithCompositeKey.Relationship(
                ...
                null,
                ConfigurationSource.Convention)
                .Unique(false, ConfigurationSource.DataAnnotation);
        ...
        public void Does_not_match_composite_dependent_PK_for_unique_FK_if_count_mismatched()
        {
            ...
            var relationshipBuilder = DependentTypeWithCompositeKey.Relationship(
                ...
                .PrincipalKey(PrincipalTypeWithCompositeKey.Metadata.GetPrimaryKey().Properties, ConfigurationSource.DataAnnotation)
                .Unique(true, ConfigurationSource.DataAnnotation);
        ...
        public void Does_nothing_if_a_foreign_key_on_the_best_candidate_property_already_exists()
        {
            ...
            var relationshipBuilder = DependentType.ForeignKey(
        ...
        public void Inverts_if_dependent_entity_type_has_navigation()
        {
            var relationshipBuilder = PrincipalType.Relationship(
                DependentType, "InverseReferenceNav", null, ConfigurationSource.Convention)
                .Unique(true, ConfigurationSource.Convention);
        ...
        {
            var relationshipBuilder = DependentType.Relationship(
                PrincipalType, null, "InverseReferenceNav", ConfigurationSource.Convention)
                .Unique(true, ConfigurationSource.Convention);
        ...
        {
            var relationshipBuilder = PrincipalType.Relationship(
                DependentType, "InverseReferenceNav", "SomeNav", ConfigurationSource.Convention)
                .Unique(true, ConfigurationSource.Convention);
